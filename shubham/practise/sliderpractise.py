import sys
from PySide2.QtWidgets import QApplication, QWidget, QLabel, QVBoxself.vbox, QCheckBox, QSlider
...
class MyWidget(QWidget):
    def _init_(self):
        ...
        self.vbox.addWidget(self.slider3)
        self.vbox.addWidget(self.slider4)
        self.setself.vbox(self.vbox)
