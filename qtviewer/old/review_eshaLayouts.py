...
class dviewer(QWidget):
    def __init__(self):
        ...
        self.vertical_widget.setMaximumWidth(400)
        ...
        self.vertical_layout.addLayout(self.statusButton_layout)
        ...
        main_layout.addWidget(self.vertical_widget)
        main_layout.addWidget(self.contents_widget)
