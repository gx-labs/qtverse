...
class CustomWidget(QWidget):
    def __init__(self):
        ...
        self.message_text = "<div style='text-align: center;'><span style='font-size: 18px; color: white; font-weight:bold;'>It's a new day!</span><br><span style='font-size: 16px; color: white;'>Claim your daily unicoins!</span></div>"
        self.messagebox.setText(self.message_text)
        self.messagebox.setStyleSheet(css_data)

        self.shadow = QGraphicsDropShadowEffect()
        self.shadow.setColor("#37547D")
