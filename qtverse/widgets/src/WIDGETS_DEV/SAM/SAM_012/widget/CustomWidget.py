...
class CustomDialog(QWidget):
    def __init__(self):
        ...
        self.label_frame1.setStyleSheet("QFrame { background-color: #F62447; border-radius: 29px; }")
        ...
        self.line.setStyleSheet("QFrame{ border: 1px solid transparent; border-top: 1px solid #F62447;}")
