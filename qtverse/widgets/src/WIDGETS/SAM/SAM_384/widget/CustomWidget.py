...
class CustomWidget(QWidget):
    def __init__(self):
        ...
        self.message_text = "<span style='font-size: 30px; color: #A5DC86;'>✓</span><span style='font-size: 18px; font-weight: bold; color: black;'>Congrats!</span><br><span style='font-size: 13px; color: #A9A9A9;'>Your account is created.</span>"
