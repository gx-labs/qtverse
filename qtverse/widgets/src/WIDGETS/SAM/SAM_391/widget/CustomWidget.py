...
class CustomWidget(QWidget):
    def __init__(self):
        ...
        self.message_text = "<div style='text-align: left;'><span style='font-size: 18px; color: black;'>localhost says</span><br><span style='font-size: 16px; color: grey;'>Welcome to Geek for Geeks</span></div>"
