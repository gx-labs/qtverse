...
class CustomWidget(QWidget):
    def __init__(self):
        ...
        self.message_text = "<span style='font-size: 30px; color: #4071F4;'>✓</span><span style='font-size: 18px; font-weight: bold; color: black;'> Completed</span><br><span style='font-size: 13px; color: black;'>You have sucessfully downloaded</span><br><span style='font-size: 13px; color: black;'>all the source code files.</span>"
        ...
        ok_button.setText("Open File")
        cancel_button.setText("Okay, Close")
