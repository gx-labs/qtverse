...
class CustomWidget(QWidget):
    def __init__(self):
        ...
        self.message_text = "<span style='font-size: 18px; font-weight: bold;'>⚠ This is an important message</span><br><span style='font-size: 13px;'>Are you sure you want to permanently</span><br><span style='font-size: 13px;'>delete this Photo?</span>"
        ...
        ok_button.setText("Learn more")
        cancel_button.setText("Start free trial")
