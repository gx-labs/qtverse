...
class CustomWidget(QWidget):
    def __init__(self):
        ...
        self.message_text = "<span style='font-size: 25px; font-weight: bold; color: grey;'>?</span><span style='font-size: 19px; font-weight: bold; color: black;'> Show preview text</span><br><span style='font-size: 13px; color: black;'>The preview text is used to get a</span><br><span style='font-size: 13px; color: black;'>better feel for the representation of styles.</span>"
        ...
        ok_button.setText("Show")
        cancel_button.setText("Hide")
