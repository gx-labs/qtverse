...
class CustomWidget(QWidget):
    def __init__(self):
        ...
        self.message_text = "<div style='text-align: left;'><span style='font-size: 22px; color: #F1514E; font-weight: bold;'>?</span><span style='font-size: 16px; color: black; font-weight:bold;'>  Are you sure you want to delete this message?</span></div>"
        self.messagebox.setText(self.message_text)
        self.messagebox.setStyleSheet(css_data)

        self.shadow = QGraphicsDropShadowEffect()
        self.shadow.setColor("#F1514E")
