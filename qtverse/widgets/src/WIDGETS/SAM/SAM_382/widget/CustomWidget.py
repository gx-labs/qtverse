...
class CustomWidget(QWidget):
    def __init__(self):
        ...
        self.message_text = "<span style='font-size: 22px; color: #F4E3C0;'>🛈</span><span style='font-size: 18px; font-weight: bold; color: black;'> Are you sure?</span><br><span style='font-size: 13px; color: grey;'>You will not be able to recover this file!</span>"
        ...
        ok_button.setText("Yes, Delete it!")
