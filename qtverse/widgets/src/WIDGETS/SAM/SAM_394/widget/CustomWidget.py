...
class CustomWidget(QWidget):
    def __init__(self):
        ...
        self.message_text = "<div style='text-align: center;'><span style='font-size: 30px; color: #A5DC86;'>✓</span><span style='font-size: 18px; color: black; font-weight:bold;'> Confirm Title</span><br><span style='font-size: 16px; color: grey;'>Confirm Message</span></div>"
