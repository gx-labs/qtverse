...
class CustomWidget(QWidget):
    def __init__(self):
        ...
        self.message_text = "<div style='text-align: center;'><span style='font-size: 18px; font-weight: bold; color: black;'>Is everything correct</span><br><span style='font-size: 22px; font-weight: bold; color: black;'>$61.58</span></div>"
