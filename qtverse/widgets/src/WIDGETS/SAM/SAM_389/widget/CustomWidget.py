...
class CustomWidget(QWidget):
    def __init__(self):
        ...
        self.message_text = "<div style='text-align: left;'><span style='font-size: 18px; font-weight: bold; color: black;'>Use Location Services?</span><br><span style='font-size: 16px; color: grey;'>In order to give directional instructions, we<br>kindly ask you to turn on the location services.</span></div>"
