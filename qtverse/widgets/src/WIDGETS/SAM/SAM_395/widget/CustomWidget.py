...
class CustomWidget(QWidget):
    def __init__(self):
        ...
        self.message_text = "<div style='text-align: center;'><span style='font-size: 20px; color: grey;'> You HAVE A BLANK PAGE<br>START ADDING CONTENT<br>OR TEMPLATES</span></div>"
        ...
        ok_button.setText("+ Add Element")
        cancel_button.setText("📝 Add Text Block")
