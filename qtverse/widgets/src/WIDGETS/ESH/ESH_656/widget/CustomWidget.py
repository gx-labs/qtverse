...
class CustomWidget(QWidget):
    def __init__(self):
        ...
        self.loading_label.setObjectName("loading_file")
        self.loading_label.setStyleSheet(css_data)
        horizontal_layout.addWidget(self.loading_label, alignment=Qt.AlignLeft)
        ...
        horizontal_layout.addWidget(self.progress_label, alignment=Qt.AlignRight)
