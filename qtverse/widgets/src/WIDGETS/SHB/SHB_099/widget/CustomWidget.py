...
class CustomWidget(QWidget):
    def __init__(self):
        ...
        self.combo_box.setFixedSize(240, 50)
        self.combo_box.addItem("Color Options")
        self.combo_box.addItem("Development")
        self.combo_box.addItem("Features")
        self.combo_box.addItem("Scale")
        indexs = [1,4,3,2]
