...
class CustomWidget(QWidget):
    def __init__(self):
        ...
        self.combo_box.addItem("Dropdown item 1")
        self.combo_box.addItem("Dropdown item 2")
        self.combo_box.addItem("Dropdown item 3")
        self.combo_box.addItem("Dropdown item 4")
        indexs = [1,4,3,2]
