...
class CustomWidget(QWidget):
    def __init__(self):
        ...
        self.radiobutton1 = QRadioButton('Value 1')
        self.radiobutton1.setChecked(True)
        self.radiobutton1.setFixedSize(50, 30)
        self.radiobutton1.clicked.connect(self.radiobutton1_pressed)
        self.radiobutton2 = QRadioButton('Value 2')
        self.radiobutton2.setFixedSize(50, 30)
        self.radiobutton2.clicked.connect(self.radiobutton2_pressed)
        self.radiobutton3 = QRadioButton('Value 3')
        self.radiobutton3.setFixedSize(50, 30)
