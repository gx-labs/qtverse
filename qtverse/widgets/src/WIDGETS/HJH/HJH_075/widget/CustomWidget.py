...
class CustomWidget(QWidget):
    def __init__(self):
        ...
        self.radiobutton1.setObjectName('male')
        ...
        self.radiobutton2.setObjectName('female')
        ...
        self.radiobutton3.setObjectName('trans')
        ...
        self.radiobutton4.setObjectName('none')
        self.radiobutton4.setFixedSize(30, 30)
