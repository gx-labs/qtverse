...
class CustomWidget(QWidget):
    def __init__(self):
        ...
        #pie
        self.round_progress_bar.rpb_setPieColor((220,245,117))  
        #text
        self.round_progress_bar.rpb_setTextColor((155,190,6))  
        self.round_progress_bar.rpb_setTextRatio(5)
        #line
        self.round_progress_bar.rpb_setLineColor((155,190,6))
