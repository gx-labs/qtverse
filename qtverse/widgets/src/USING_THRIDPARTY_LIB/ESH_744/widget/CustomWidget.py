...
class CustomWidget(QWidget):
    def __init__(self):
        ...
        #text
        self.round_progress_bar.rpb_setTextColor((230,105,2))  
        self.round_progress_bar.rpb_setTextRatio(6)
        self.round_progress_bar.rpb_setTextFont('Times New Roman')
        #line
        self.round_progress_bar.rpb_setLineColor((230,105,2)) 
        self.round_progress_bar.rpb_setLineStyle('DashLine')
        self.round_progress_bar.rpb_setLineCap('SquareCap')
        self.round_progress_bar.rpb_setLineWidth(9)
