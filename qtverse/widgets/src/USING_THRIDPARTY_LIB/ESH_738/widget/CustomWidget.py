...
class CustomWidget(QWidget):
    def __init__(self):
        ...
        #style
        self.round_progress_bar.rpb_setBarStyle('Donet')
        #circle
        self.round_progress_bar.rpb_setCircleColor((187,226,146))  
        #text
        self.round_progress_bar.rpb_setTextColor((55,143,2)) 
        self.round_progress_bar.rpb_setTextRatio(7)
        #line      
        self.round_progress_bar.rpb_setLineColor((55,143,2))
